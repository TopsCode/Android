...
import com.tops.PhpWebserviceCRUD.Adapter.AdapterData;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mManager = new LinearLayoutManager(MainActivity.this, RecyclerView.VERTICAL,false);
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for(int i = 0 ; i < response.length(); i++)
                        {
                            try {
                                ...
                                md.setProd(data.getString("prod"));
                                mItems.add(md);
