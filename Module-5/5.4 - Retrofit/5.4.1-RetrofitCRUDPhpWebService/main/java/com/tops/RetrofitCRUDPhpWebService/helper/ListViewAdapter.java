package com.tops.RetrofitCRUDPhpWebService.helper;
...
import com.tops.RetrofitCRUDPhpWebService.R;
...
public class ListViewAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        holder.txt_age=view.findViewById(R.id.age);
        holder.txt_mobile=view.findViewById(R.id.mobile);
        holder.txt_mail=view.findViewById(R.id.mail);
